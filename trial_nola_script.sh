...
deepspeed /home/avaidya7/CPT_VLM/llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /home/avaidya7/llava_instruct_80k.json \
    --image_folder /home/avaidya7/coco/train2017/train2017 \
    ...
    --bf16 True \
    --output_dir /home/avaidya7/checkpoints/llava-v1.5-7b-task-lora \
    --num_train_epochs 1 \
