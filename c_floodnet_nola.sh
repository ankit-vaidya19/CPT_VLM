...
deepspeed /home/avaidya7/CPT_VLM/llava/train/train_mem.py \
    ...
    --model_name_or_path /home/avaidya7/checkpoints/llava-v1.5-7b-tv100_nola_lora_merged\
    --version v1 \
    ...
    --bf16 True \
    --output_dir /home/avaidya7/checkpoints/llava-v1.5-7b-c_floodnet_nola \
    --num_train_epochs 1 \
    ...
    --report_to wandb \
    --run_name llava1.5_c_nola_floodnet
